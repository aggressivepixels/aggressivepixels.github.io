...
styles = do
  ...
  star & byClass postEntryTitleClass
    ? do
        marginTop nil
        marginBottom (em 0.25)
  star & byClass postEntryDescriptionClass
    ? do
        marginTop nil
        marginBottom (em 0.5)
  star & byClass postTitleClass
    ? do
        fontSize (em 2.5)
        marginTop nil
  ...
  star & byClass notFoundClass
    ? do
        ...
        padding (em 1.0) (em 1.0) (em 1.0) (em 1.0)
        textAlign center
  star & byClass notFoundTitleClass
    ? do
        color accentColor
        fontSize (em 4.0)
        marginBottom nil
...
desktopStyle :: CSS
desktopStyle = do
  (main <> (star & byClass navContentClass))
    ? do
        marginLeft auto
        marginRight auto
        width (px 800.0)
